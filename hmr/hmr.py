...
MODEL_PATH = os.path.join(module_path, "E:\Project Deaf\mocap-hmr-tflite-main\models\hmr\model\HMR.tflite")
THETA_PATH = os.path.join(module_path, "E:\Project Deaf\mocap-hmr-tflite-main\hmr\model\initial_theta.npy")
